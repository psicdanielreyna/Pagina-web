    ...
    <header className="sticky top-0 z-[60] w-full border-b bg-white shadow-sm">
      <div className="container mx-auto max-w-6xl flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center">
          <Sheet>
            <SheetTrigger aria-label="Abrir menú" className="inline-flex items-center justify-center rounded-md p-2 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-black/10">
        ...
        {/* Marca centrada: logo.png (más pequeño que antes, bien centrado) */}
        ...
        {/* Redes (solo íconos) a la derecha */}
