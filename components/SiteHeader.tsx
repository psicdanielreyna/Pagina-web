...
export default function SiteHeader() {
  ...
  return (
    <div className="sticky top-0 z-[60] w-full">
      <PromoBanner />
      <header className="w-full backdrop-blur" style={{ background: isDark ? "rgba(15,15,26,0.92)" : "rgba(248,245,240,0.92)", borderBottom: `0.5px solid ${isDark ? "rgba(255,255,255,0.06)" : "rgba(0,0,0,0.08)"}` }}>
