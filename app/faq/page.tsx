  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <header className="mb-8">
        <h1 className="text-3xl font-extrabold tracking-tight">Preguntas frecuentes</h1>
        <p className="mt-2 text-muted-foreground">
          Aquí encontrarás respuestas a las dudas más comunes. Si no ves la tuya,{" "}
          <a href="/contacto" className="underline">escríbeme aquí</a>.
        </p>
      </header>
        ...
        {faqs.map((item) => (
          ...
          >
            <summary className="flex cursor-pointer list-none items-center justify-between gap-4 text-emerald-900">
              <h2 className="mx-auto text-base font-semibold text-emerald-900">{item.q}</h2>
              <span
                aria-hidden
