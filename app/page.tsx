...
export default function HomePage() {
  return (
    <div className="space-y-16">
     ...
     {/* RECURSOS DESTACADOS (mismo tamaño que en Tienda) */}
<section className="py-12 md:py-16">
      ...
      {[
        {
          ...
          excerpt:
            "Técnicas concretas para bajar el ruido mental cuando sientes que la cabeza no para.",
          href: "/tienda",
          // ⬇️ Usa aquí la MISMA ruta de imagen que en /tienda
          img: "/images/tienda/apagar-tu-mente.jpg",
        ...
        },
        {
          ...
          href: "/tienda",
          // ⬇️ Usa aquí la MISMA ruta de imagen que en /tienda
          img: "/images/tienda/arte-de-creer-en-ti.jpg",
        ...
        <Link
          key={p.title}
          href={p.href}
          className="group flex h-[420px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:shadow-md"
        >
          {/* Imagen (altura fija como en Tienda) */}
          ...
          <div className="flex flex-1 flex-col p-4">
            ...
            {/* Botón pegado abajo para igualar alturas */}
            <div className="mt-auto pt-4">
              <span
                className="inline-flex items-center rounded-full border border-slate-200 px-4 py-2 text-sm text-slate-700
