...
const COVERS: Record<string, { src: string; alt: string }> = {
  ...
  "el-arte-de-creer-en-ti": {
    src: "/images/tienda/el-arte-de-creer-en-ti.png", // asegúrate de tener esta imagen
...
export default function ProductoPage({ params }: { params: { slug: string } }) {
  ...
  const concepto = manual.slug; // lo mostramos para que el usuario lo copie si quieres
    ...
    <section className="py-10 md:py-14">
      <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          {/* “Opciones” reemplazadas por métodos de pago */}
